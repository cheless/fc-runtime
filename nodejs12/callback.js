...
const maxResponsePayloadSize = '128MB';

exports.createInitCallback = function(client) {
    return function(err){
        logger.getLogger().error('runtime inited failed, start to exit.');
...
exports.createInvokeCallback = function(headers, client, callback) {
    ...
    if (isHttpMode) {
        return function(err, data, httpParams) {
            consume(err, data, httpParams);
        };
    }
